...
module.exports.handler = (event, context, callback) => {
  ...
  const query = `SELECT MONTH(insp_d8) as month, count(*) as num FROM ride_inspections WHERE cond_num != '15' and YEAR(insp_d8) = "${year}" GROUP BY MONTH(insp_d8) ORDER BY month ASC`;
  conx.query(
    query,
